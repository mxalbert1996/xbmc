...
CImageLoader::CImageLoader(const std::string& path,
                           ...
                           const bool useCache)
  : m_path(path), m_texture(nullptr), m_targetWidth(targetWidth), m_targetHeight(targetHeight),
...
CGUILargeTextureManager::CLargeTexture::CLargeTexture(const std::string& path,
                                                      ...
                                                      unsigned int targetHeight,
                                                      CAspectRatio::ASPECT_RATIO aspectRatio)
  : m_path(path), m_targetWidth(targetWidth), m_targetHeight(targetHeight), m_aspectRatio(aspectRatio)
{
  m_refCount = 1;
  m_timeToDelete = 0;
}
