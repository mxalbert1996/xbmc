                          ...
                          CAspectRatio::ASPECT_RATIO aspectRatio)
{
  ...
  if (aspectRatio == CAspectRatio::AR_STRETCH)
  {
    // noop
  }
  else if (aspectRatio == CAspectRatio::AR_CENTER)
  {
    width = pImage->Width();
  ...
  else
  {
    ...
    if (aspectRatio == CAspectRatio::AR_SCALE)
    {
    ...
    else if (aspectRatio == CAspectRatio::AR_KEEP)
    {
      if (heightFromWidth > height)
        width = (unsigned int)(height * aspect + 0.5f);
      else
